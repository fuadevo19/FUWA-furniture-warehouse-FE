...
import { getProdukDetail, updateProduct } from '@/queries/product'
...
export default {
  ...
  async mounted() {
    ...
    const productRes = await getProdukDetail(id)
    this.data = productRes
  },
  methods: {
...
<template>
  <form @submit="handleSubmit">
    <h1 class="font-bold text-blue-500 mb-3 mt-1 text-center text-2xl">Detail Produk</h1>
